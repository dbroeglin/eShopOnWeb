...
// param sqlAdminPassword string = guid(subscription().subscriptionId, resourceGroup().id, environmentName)

// @secure()
// @description('Application user password')
// #disable-next-line secure-parameter-default
// param appUserPassword string = 'SuperSecretPassword123!'
...
module web '../../infra/core/host/appservice.bicep' = {
  name: 'web'
  // scope: rg
  params: {
...
// module catalogDb '../../infra/core/database/sqlserver/sqlserver.bicep' = {
//   name: 'sql-catalog'
//   // scope: rg
//   params: {
...
// module identityDb '../../infra/core/database/sqlserver/sqlserver.bicep' = {
//   name: 'sql-identity'
//   // scope: rg
//   params: {
...
// module keyVault '../../infra/core/security/keyvault.bicep' = {
//   name: 'keyvault'
//   // scope: rg
//   params: {
